...
class Ref_pekerjaan extends CI_Controller {
    ...
    // view
    function index(){
    $data['page'] = 'v_ref_pekerjaan';
    $this->load->view('v_main',$data);
    }

    function data(){
    $this->load->view('v_ref_pekerjaan_data');
    }

    function editor(){
    $this->load->view('v_ref_pekerjaan_editor');
    }
    ...
    public function page()
    {
      ...
      $data = $this->M_ref_pekerjaan->get_data($search,$from_page,$per_page); // ambil data
    ...
    function get_for_edit(){
      ...
      $data = $this->M_ref_pekerjaan->get($id);
    ...
    function add(){
        ...
        if (isset($data['id_pekerjaan'])) {
          $data['id_pekerjaan'] = NULL;
        };
        $insert = $this->M_ref_pekerjaan->insert($data);
        if (!$insert) {
    ...
    function update(){
      ...
      $update = $this->M_ref_pekerjaan->update_by_id($data,$id);
    }

    // fungsi hapus
    function delete(){
      $id = $this->input->post('id');
      $delete = $this->M_ref_pekerjaan->delete_by_id($id);
    }
