...
class Jabatan extends CI_Controller {
    ...
    function data(){
    $this->load->view('v_jabatan_data');
    }

    function editor(){
    $this->load->view('v_jabatan_editor');
    }
    ...
    public function page()
    {
      ...
      $data = $this->M_jabatan->get_data($search,$from_page,$per_page); // ambil data
    ...
    function update(){
      ...
      parse_str($_POST['data'], $data);
      $id = $data['id_jabatan'];
      $update = $this->M_jabatan->update_by_id($data,$id);
    }

    // fungsi hapus
    function delete(){
      $id = $this->input->post('id');
      $delete = $this->M_jabatan->delete_by_id($id);
    }
